...
public interface ActivityParticipationRepository extends JpaRepository<ActivityParticipation, ActivityParticipationId> {
    ...
    @Query("SELECT new com.dalv.bksims.models.dtos.social_points_management.ParticipantResponse(ap.user, ap.pointsApproved) " +
    ...
    List<ParticipantResponse> findParticipantsByActivityIdByIdIn(
